...
for(theta in theta_list_star)
{
  ...
  { 
    ...
    #ggsave (paste0("D:/Research/structural equation/resultpower_tauYSep/pi1=pi3=0.01theta=",theta,"tauY=",tauy,"tauX=",tauX,"M=",M,"Power.png"), p1,width = 11,             # хо?
    #       height = 11)
    #ggsave (paste0("D:/Research/structural equation/resultpower_tauYSep/pi1=pi3=0.01theta=",theta,"tauY=",tauy,"tauX=",tauX,"M=",M,"Coverage.png"), p1,width = 11,             # хо?
    #      height = 11)
  }
}
