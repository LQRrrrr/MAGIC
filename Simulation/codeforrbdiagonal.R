     ...
     {for (design in simulation)
      ...
      print(i)
       ...
       { ind3=sample(setdiff(1:M,causalsnps),round(M*pi3))# valid for sj
        ...
        # ele2=sum(over2$gamma_exp1[overlap_index]*over2$gamma_exp2[overlap_index]/(se_y[overlap_index]^2))+sum(over2$gamma_exp1[setdiff(indx,overlap_index)]*betahat_m[setdiff(indx,overlap_index)]/(se_y[setdiff(indx,overlap_index)]^2))
        #ele3=sum(over2$gamma_exp1[overlap_index]*over2$gamma_exp2[overlap_index]/(se_y[overlap_index]^2))+sum(betahat_x[setdiff(indm,overlap_index)]*over2$gamma_exp2[setdiff(indm,overlap_index)]/(se_y[setdiff(indm,overlap_index)]^2))
        ...
        #  ele5=sum((betanew_x^2-senew_x^2)/(se_m[indx]^2))
        # ele1=sum((betanew_x^2-senew_x^2)/(se_y[indx]^2))
        #  ele2=sum(betanew_x*over2$gamma_exp2[indx]/(se_y[indx]^2))
        #  ele3=sum(over2$gamma_exp1[indm]*betanew_m/(se_y[indm]^2))
        #  ele4=sum((betanew_m^2-senew_m^2)/(se_y[indm]^2))
        #  ele5=sum((betanew_x^2-senew_x^2)/(se_m[indx]^2))
